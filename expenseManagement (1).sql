...
--
-- Host: localhost
-- Generation Time: May 01, 2019 at 08:43 AM
...
CREATE TABLE `User` (
  `userId` varchar(20) NOT NULL,
  `adminId` varchar(20) DEFAULT 'admin01',
  `fname` varchar(15) DEFAULT NULL,
  `lname` varchar(15) DEFAULT NULL,
  `email` varchar(30) DEFAULT NULL,
...
INSERT INTO `User` (`userId`, `adminId`, `fname`, `lname`, `email`, `password`, `age`, `contact`, `address`, `netIncome`, `otherIncome`) VALUES
('user01', 'admin01', 'Bhaskar', 'U', 'bhaskar123@gmail.com', 'user123', 20, 123456789, 'Kolkata', 22400, 2000),
('user02', 'admin01', 'Akash', 'p', 'akash123@gmail.com', 'user123', 20, 456321789, 'Banglore', 6500, 1000),
('user03', 'admin01', 'Ajith', 'gv', 'ajith123@gmail.com', 'user123', 21, 789654123, 'Sirsi', 15000, 500),
('user04', 'admin01', 'Akhil', 'S', 'akhil123@gmail.com', 'user123', 22, 852369147, 'Kengeri', 9500, 4500),
('user05', 'admin01', 'Arun', 'GA', 'arun123@gmail.com', 'user123', 22, 456258741, 'Shimoga', 26500, 2500),
('user06', 'admin01', 'Shrikant', 'p', 'shrikant123@gmail.com', 'user123', 23, 95123546, 'Bidar', 4500, 5500),
('user07', 'admin01', 'Amit', 'S', 'amit123@gmail.com', 'user123', 23, 963987412, 'Delhi', 42000, 1550),
('user08', 'admin01', 'Alok', 't', 'alok123@gmail.com', 'user123', 20, 753159852, 'Banglore', 7500, 1500),
('user09', 'admin01', 'Adarsh', 't', 'adarsh123@gmail.com', 'user123', 21, 125896321, 'Noida', 45000, 1250),
('user10', 'admin01', 'Suman', 'Du', 'suman123@gmail.com', 'user123', 21, 26598741, 'Noida', 35000, 2500);
